...
import PriceTable from "./Table/Table";
import "./Main.css";
  ...
  return (
    <main className="App__main">
      <Flex
        ...
        padding={{ md: "50px 0 80px", lg: "110px 0 140px" }}
      >
        <Box
          id="about-us-section"
        ...
        >
          <Heading
            as="h2"
            fontSize={{ base: "18px", sm: "20px", md: "22px", lg: "26px" }}
          >
            Швидкий та якісний ремонт залог вашої внутрішньої гармонії
          </Heading>
          <Heading
            className="App__main-title"
            as="h1"
            fontSize={{ base: "22px", sm: "24px", md: "26px", lg: "30px" }}
            marginTop={{ base: "25px", sm: "18px", md: "20px", lg: "35px" }}
          >
            Phone Up
          </Heading>
          <Text
            sx={{ marginTop: "30px", maxWidth: "800px" }}
        ...
        <Box
          ...
          display={{ sm: "none", md: "inline-block", lg: "inline-block" }}
          marginLeft={{ sm: "none", md: "10px", lg: "none" }}
        >
          <Img
            width={{ sm: "680px" }}
            src={ServiceImage1}
      ...
      <Box className="App__main-services" id="more-section">
        ...
        >
          ...
          <Text
            ...
            margin={{ md: "25px 0 8px", lg: "50px 0 10px" }}
          >
            Що ми ремонтуємо?
          </Text>
          <Flex>
          ...
          <Text
            sx={{ textAlign: "center" }}
            maxWidth={{ base: "80%" }}
            margin={{ base: "15px 0 0", md: "30px 0 0", lg: "50px 0 0" }}
          >
        ...
        <Flex sx={{ margin: "50px 0", justifyContent: "center" }}>
          <ScrollLink
            to="contacts-section"
            spy={true}
            smooth={true}
