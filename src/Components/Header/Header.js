    ...
    <header className="App__header" id="header-section">
      <Flex sx={
        ...
        <Box sx={
          ...
          <Breadcrumb>
            <BreadcrumbItem>
              <ScrollLink className="App__header-link" to="about-us-section"
                spy={true}
                smooth={true}
                duration={600}>
                <Text fontSize={
            ...
            <BreadcrumbItem>
              <ScrollLink className="App__header-link" to="services-section"
                spy={true}
                smooth={true}
                duration={1000}>
                <Text fontSize={
            ...
            <BreadcrumbItem>
              <ScrollLink className="App__header-link" to="contacts-section"
                spy={true}
                smooth={true}
                duration={1000}>
                <Text fontSize={
        ...
        <Spacer/>
        <Box className="App__header-phone-number-box"
          sx={
            {fontWeight: "600"}
        }>
          <Link fontSize={
        ...
        <Box className="App__main-burger-menu"
          sx={
            {
              color: "black",
              marginLeft: "15px"
